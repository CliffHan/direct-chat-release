...
Include your OS version, app version (e.g. v0.1.0) and steps to reproduce, then email <cliff@clifftop.win> or open an issue on the [GitHub repo](https://github.com/CliffHan/direct-chat-release).
